...
export default function BrainDumpPage() {
  ...
  return (
    <div className={`min-h-screen pb-16 transition-colors duration-500 ${isFocusMode ? "bg-[#faf9f6] dark:bg-[#121613]" : "bg-gradient-to-br from-cream via-warm-white to-broken-white dark:from-[#12181f] dark:via-[#151c24] dark:to-[#12181f]"}`}>
      {/* Top Header Bar */}
      <AnimatePresence>
        {!isFocusMode && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="sticky top-0 z-30 glass bg-cream/85 dark:bg-[#161e27]/90 backdrop-blur-md border-b border-broken-white/80 dark:border-slate-700/80 shadow-xs"
          >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className={`paper-braindump rounded-3xl p-6 sm:p-10 pl-8 sm:pl-14 shadow-xl relative space-y-6 ${isFocusMode ? "!bg-transparent !border-none !shadow-none" : ""}`}>
          ...
          {saved ? (
            ...
            <div className="space-y-6">
              ...
              <div className="pt-4 border-t border-slate-300/50 dark:border-slate-700/50 flex flex-wrap items-center justify-between gap-4 text-xs text-slate-500 dark:text-gray-300 font-sans">
                ...
                {lastSavedTime && (
                  <div className="flex items-center gap-1.5 text-sage-dark dark:text-emerald-400 font-medium">
